...
WordsFoundMsg: .asciiz "\nHere is the list of words you found:\n"
...
validWordMsg: .asciiz "That is a vaild word! Time has been added.\n\n"
...
gfour:
bgt $t4, 5, gfive
sw $zero, timeleft	# Clear clock
j GameEnded		# Jump to ending screen
gfive:
notfound:
li $v0, 4
la $a0, out
...
li $v0, 4
syscall
GameEnded:		# Jumps here if !e is entered
